            ...
            <div className="relative h-32 sm:h-44 overflow-hidden bg-mauve-900/5">
              {s.imageUrl ? (
                ...
                <div className="h-full w-full grid place-items-center">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-mauve-400/60"><path d="M12 2a5 5 0 015 5c0 3-2 5-5 8-3-3-5-5-5-8a5 5 0 015-5z"/><circle cx="12" cy="7" r="1.5"/></svg>
                </div>
              )}
              {s.category && (
